...
qualitatives_path = os.path.join(BASE_DIR, 'descriptive_analysis', 'figs', 'bivarie', '2qualitatives', 'Lots')
quantitatives_path = os.path.join(BASE_DIR,'descriptive_analysis', 'figs', 'bivarie', '2quantitatives', 'Lots')
quantitativeVSqualitative_path = os.path.join(BASE_DIR,'descriptive_analysis', 'figs', 'bivarie', 'quantitativeVSqualitative')

univarie_path = os.path.join(BASE_DIR, 'descriptive_analysis', 'figs', 'univarie', 'Lots')
...
if __name__ == '__main__':
    ...
    analyse_univariee_manon.execute_file(df_lots_cleaned, df_buyers_cleaned, df_suppliers_cleaned, df_criteria_cleaned, df_names_cleaned, is_cleaned_data=True)
