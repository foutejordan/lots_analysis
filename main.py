...
df_lots_max = df_lots.copy()
df_lots_max['cpv_name'] = df_lots_max['cpv'].astype(str).str[:2]
...
if __name__ == '__main__':
    ...
    # single_var_lots.execute_file(df_lots_max)
    # cpv_single_var.execute_file(df_lots_max)
